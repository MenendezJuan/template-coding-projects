...
- [✋ Introducción `Template-coding-projects`](#-introducción-template-coding-projects)
- [❓ Cómo usar esta plantilla](#-cómo-usar-esta-plantilla)
- [🔥 Qué hacer después de usar `Template-template-coding-projects`](#-qué-hacer-después-de-usar-template-template-coding-projects)
...
## ✋ Introducción `Template-coding-projects`
...
Para usar este template, haga clic en el botón **Use this template** que se muestra en la sección superior en la [raíz del repositorio]..., luego cree un nuevo repositorio.

Otra forma es iniciar el proceso de creación de un nuevo repositorio y seleccionar esta plantilla en la sección superior.

## 🔥 Qué hacer después de usar `Template-template-coding-projects`
...
> [!NOTE]
> Estas configuraciones pueden ser diferentes según sus necesidades.
...
Por defecto, el archivo `CODEOWNERS` contiene el valor adecuado para cualquier repositorio del proyecto.

```plaintext
* @crosstech/CTServices
```
...
Por defecto, las plantillas de problemas contienen el valor adecuado para cualquier repositorio del proyecto `CTServices`, includo el enlace al proyecto.
...
Por defecto, la plantilla de solicitud de extracción contiene el valor adecuado para cualquier repositorio del proyecto `CTServices`.
...
- Reemplace el título `Template-coding-projects` por el título de su repositorio.
...
Include a PR labeling workflow caller. It consumes the reusable workflows stored in ....

### Liberation

`/.github/workflows/liberation.yml`

The versioning workflow contains a caller to the reusable workflow stored in ....
...
`project-automation` consists in a simple workflow caller job to run ...
